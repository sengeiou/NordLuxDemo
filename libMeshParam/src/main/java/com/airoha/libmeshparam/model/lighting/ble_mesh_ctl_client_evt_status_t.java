...
/**
 * Event parameter of CTL client model event @ref BLE_MESH_LIGHT_CTL_CLIENT_EVT_STATUS.
 */

public class ble_mesh_ctl_client_evt_status_t extends ble_mesh_base_status_t implements Serializable{
    /** The present value of the Light CTL Lightness state. */
    public short present_ctl_lightness;
    ...
    public short target_ctl_lightness;
