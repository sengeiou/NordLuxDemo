...
public class RemoteMenuActivity extends AppCompatActivity {
    ...
    private void initView() {
        recyclerView=findViewById(R.id.RemoteRecycleView);
        recyclerView.addItemDecoration(new MyDecoration());
        recyclerView.setLayoutManager(new LinearLayoutManager(RemoteMenuActivity.this));
        recyclerView.setAdapter(new RemoteMenuAdapter(RemoteMenuActivity.this));
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.single_1:
                        Intent intent01=new Intent(RemoteMenuActivity.this, HomeActivity.class);
                        startActivity(intent01);
                        finish();
                        break;
                    case R.id.single_2:
                        Intent intent02=new Intent(RemoteMenuActivity.this, MenuActivity.class);
                        startActivity(intent02);
                        finish();
                        break;
                    case R.id.single_3:
                        Intent intent03=new Intent(RemoteMenuActivity.this, BridgeMenuActivity.class);
                        startActivity(intent03);
                        finish();
                        break;
                    case R.id.single_4:
                        Intent intent04=new Intent(RemoteMenuActivity.this,SensorMenuActivity.class);
                        startActivity(intent04);
                        finish();
                        break;
                    case R.id.single_5:
//                        Intent intent05=new Intent(RemoteMenuActivity.this, RemoteMenuActivity.class);
...
//                        startActivity(intent08);
                        break;
                    case R.id.single_9:
                        Intent intent09=new Intent(RemoteMenuActivity.this, SettingMenuActivity.class);
                        startActivity(intent09);
                        finish();
                        break;
                    case R.id.single_10:
                        Intent intent10=new Intent(RemoteMenuActivity.this, UpdateMenuActivity.class);
