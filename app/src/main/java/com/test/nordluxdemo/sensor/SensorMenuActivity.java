...
public class SensorMenuActivity extends AppCompatActivity {
    ...
    private void initView() {
        recyclerView=findViewById(R.id.SensorRecycleView);
        recyclerView.addItemDecoration(new MyDecoration());
        recyclerView.setLayoutManager(new LinearLayoutManager(SensorMenuActivity.this));
        recyclerView.setAdapter(new SensorMenuAdapter(SensorMenuActivity.this));
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.single_1:
                        Intent intent01=new Intent(SensorMenuActivity.this, HomeActivity.class);
                        startActivity(intent01);
                        finish();
                        break;
                    case R.id.single_2:
                        Intent intent02=new Intent(SensorMenuActivity.this, MenuActivity.class);
                        startActivity(intent02);
                        finish();
                        break;
                    case R.id.single_3:
                        Intent intent03=new Intent(SensorMenuActivity.this, BridgeMenuActivity.class);
                        startActivity(intent03);
                        finish();
                        break;
                    case R.id.single_4:
//                        Intent intent04=new Intent(MenuActivity.this,HomeActivity.class);
//                        startActivity(intent04);
                        break;
                    case R.id.single_5:
                        Intent intent05=new Intent(SensorMenuActivity.this, RemoteMenuActivity.class);
...
//                        startActivity(intent08);
                        break;
                    case R.id.single_9:
                        Intent intent09=new Intent(SensorMenuActivity.this, SettingMenuActivity.class);
                        startActivity(intent09);
                        finish();
                        break;
                    case R.id.single_10:
                        Intent intent10=new Intent(SensorMenuActivity.this, UpdateMenuActivity.class);
