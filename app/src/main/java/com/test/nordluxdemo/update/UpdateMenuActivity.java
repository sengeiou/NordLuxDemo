...
public class UpdateMenuActivity extends AppCompatActivity {
    ...
    private void initView() {
        recyclerView=findViewById(R.id.UpdateRecycleView);
        recyclerView.addItemDecoration(new MyDecoration());
        recyclerView.setLayoutManager(new LinearLayoutManager(UpdateMenuActivity.this));
        recyclerView.setAdapter(new UpdateMenuAdapter(UpdateMenuActivity.this));
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.single_1:
                        Intent intent01=new Intent(UpdateMenuActivity.this, HomeActivity.class);
                        startActivity(intent01);
                        finish();
                        break;
                    case R.id.single_2:
                        Intent intent02=new Intent(UpdateMenuActivity.this, MenuActivity.class);
                        startActivity(intent02);
                        finish();
                        break;
                    case R.id.single_3:
                        Intent intent03=new Intent(UpdateMenuActivity.this, BridgeMenuActivity.class);
                        startActivity(intent03);
                        finish();
                        break;
                    case R.id.single_4:
                        Intent intent04=new Intent(UpdateMenuActivity.this, SensorMenuActivity.class);
                        startActivity(intent04);
                        finish();
                        break;
                    case R.id.single_5:
                        Intent intent05=new Intent(UpdateMenuActivity.this, RemoteMenuActivity.class);
...
//                        startActivity(intent08);
                        break;
                    case R.id.single_9:
                        Intent intent09=new Intent(UpdateMenuActivity.this,SettingMenuActivity.class);
